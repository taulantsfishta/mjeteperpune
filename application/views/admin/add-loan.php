        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <strong>Shto huazim për: <?php echo html_escape($worker['workers_name']); ?></strong>
                </div>

                <div class="card-body">
                    <form method="post" action="<?php echo base_url('admin/workers/add_loan/' . $worker['id']); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" min="0.01" name="amount" class="form-control" placeholder="P.sh. 50.00" required>
                        </div>
                        ...
                        <button type="submit" class="btn btn-primary">Ruaj huazimin</button>
