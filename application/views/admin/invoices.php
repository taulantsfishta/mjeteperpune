<style>
    ...
    @media (min-width: 1025px) {
        .content-grid {
            align-items: stretch;
            /* forces both columns to equal height */
        }
        ...
        .table-wrap {
            flex: 1 1 auto;
            /* makes the table fill available space */
        }

        #search_results_container {
            flex-shrink: 0;
            /* keeps search results visible below */
        }
    }
    ...
    #sales_form>.row:last-of-type .col-lg-10 {
        ...
        padding: 0;
        /* remove Bootstrap column padding so card edges line up */
    }
    ...
    #sales_form>.row:last-of-type .btn {
        width: 70%;
        /* adjust to 80% or 100% if you want wider */
        padding: 14px 0;
        font-size: 15px;
        border-radius: 8px;
        font-weight: bold;
    ...
    @media (max-width: 768px) {
        ...
        #invoiceData tbody td:nth-child(1)::before {
            content: "ID";
        }

        #invoiceData tbody td:nth-child(2)::before {
            content: "Klienti";
        }

        #invoiceData tbody td:nth-child(3)::before {
            content: "Adresa";
        }

        #invoiceData tbody td:nth-child(4)::before {
            content: "Telefoni";
        }

        #invoiceData tbody td:nth-child(5)::before {
            content: "Totali";
        }

        #invoiceData tbody td:nth-child(6)::before {
            content: "Parapagesë";
        }

        #invoiceData tbody td:nth-child(7)::before {
            content: "Shuma e mbetur";
        }

        #invoiceData tbody td:nth-child(8)::before {
            content: "Data e krijimit";
        }

        #invoiceData tbody td:nth-child(9)::before {
            content: "Veprimi";
        }
    ...
    .debt-client-suggestion.keyboard-active {
        background: #dbeafe;
        outline: 2px solid #93c5fd;
        outline-offset: -2px
    }

    .invoice-debt-client-option.keyboard-active {
    ...
    /* Pamja e faturës së ruajtur: e njëjtë me add-invoices */
...
<script>
    ...
    $(document).ready(function() {
        ...
        function addRow() {
            ...
            `);
                const invoiceScroller = document.querySelector('.table-col > .table-wrap');
                if (invoiceScroller) invoiceScroller.scrollTop = invoiceScroller.scrollHeight;
                const newName = $('#product_rows').find('.product_name').last()[0];
        ...
        $(document).on('input', '.product_name', function() {
            var thisSearchSequence = ++productSearchSequence;
            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState === 4 && xhr.status === 200 && thisSearchSequence === productSearchSequence) {
        ...
        $(document).ready(function() {
            ...
            $("#backButton").click(function() {
                ...
                $.ajax({
                    ...
                    method: 'GET',
                    data: {
                        invoice_user_id: <?php echo (int)$invoiceSelectedUserId; ?>
                    },
        ...
        function loadDetailsTable(invoiceId) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    const invoiceScroller = document.querySelector('.table-col > .table-wrap');
                    if (invoiceScroller) invoiceScroller.scrollTop = 0;
...
<div class="modal" id="invoiceDebtClientModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Zgjidh klientin nga lista e borxheve</h4><button type="button" class="close" data-bs-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
