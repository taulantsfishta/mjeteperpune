...
<script>
    function yesnoCheck() {
        ...
        if (yesCheck.checked) {
            ifYesDiv.style.display = 'block'; // Show the div
        } else {
            ifYesDiv.style.display = 'none'; // Hide the div
        }
    }
</script>
...
<script>
    ...
    const otherCheckboxes = document.querySelectorAll('input[name="role_action[]"]:not(#selectAllCheckbox)');

    selectAllCheckbox.addEventListener('change', function() {
        // Disable the checkboxes within the loop when the "Select All" checkbox is checked
        otherCheckboxes.forEach(function(checkbox) {
            checkbox.disabled = selectAllCheckbox.checked;
        });
    });

    function handleOtherCheckboxChange(clickedCheckbox) {
        if (clickedCheckbox !== selectAllCheckbox) {
            // Disable the "Select All" checkbox if any checkbox within the loop is checked
