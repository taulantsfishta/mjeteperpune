                                   ...
                                   <div class="form-group row">
                                       ...
                                       <div class="col-md-7 controls">
                                           <div class="form-group">
                                               <input class="vertical-spin" type="text" name="power_id" data-bts-button-down-class="btn btn-secondary btn-outline" data-bts-button-up-class="btn btn-secondary btn-outline" value="" name="vertical-spin" required>
                                           </div>
                                       </div>
                                   </div>
                               </div>
